...
console.log("[2/5] Live-service JavaScript syntax");
...
console.log("LOCAL VERIFIED: codec, state machine, service, two-user flow, HTTP API, and browser UI smoke checks are green.");
console.log("NOTE: CKB RISC-V contract and real testnet verification are separate checks in HOW_TO_VERIFY.md.");
